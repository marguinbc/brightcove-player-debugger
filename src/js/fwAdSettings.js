...
import { IDs } from './componentIDs.js';
  ...
  let getAdSettingsStr = (player) => {
    ...
    let previousStateStr = "",
        ...
        '<span class="adMsg">adTechOrder:</span> ' + player.FreeWheelPlugin.settings.adTechOrder.toString().split(' '),
        ...
        '<span class="adMsg">serverUrl:</span> ' + player.FreeWheelPlugin.settings.Html5.serverUrl,
        '<span class="adMsg">capabilities:</span> ' + player.FreeWheelPlugin.settings.Html5.capabilities.toString().split(' '),
        '<span class="adMsg">keyValues:</span> ' + player.FreeWheelPlugin.settings.Html5.keyValues.toString().split(' '),
        '<span class="adMsg">temporalSlots:</span> ' + player.FreeWheelPlugin.settings.Html5.temporalSlots.toString().split(' '),
